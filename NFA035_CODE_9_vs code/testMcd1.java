...
public class testMcd1 extends JFrame {
    ...
    public testMcd1() {
        ...
        add.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e2) {
                ...
                String e1 = e.getText();
                String d1 = d.getText();
                String s = (String) rA.getSelectedItem();
                if (id1 != null && c1 != null && e1 != null && d1 != null) {
                    try {
                        FileOutputStream reader = new FileOutputStream("data.dat", true);
                        DataOutputStream f = new DataOutputStream(reader);
                        f.writeInt(Integer.parseInt(id1));
                        f.writeUTF(s);
                        f.writeInt(Integer.parseInt(c1));
                        f.writeUTF(e1);
                        f.writeUTF(d1);
                        //f.writeBytes("\n");
                        //f.close();
        ...
        read.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    int c1 = data.readInt();
                    String d1 = data.readUTF();
                    String e1 = data.readUTF();
                    model2.addRow(new Object[]{id1, c1, e1, d1});
                } catch (IOException ioe) {
                    JOptionPane.showMessageDialog(null, "Error");
                }
            }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(testMcd1::new);
    }
}
